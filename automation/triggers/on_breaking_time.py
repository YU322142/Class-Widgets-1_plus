...
@register_trigger("classisland.lessons.onBreakingTime", "课间休息时")
class OnBreakingTimeTrigger(TriggerBase):
    ...
    def Loaded(self) -> None:
        ...
        self._handler = _on_breaking
        bridge.AddOnBreakingTimeHandler(_on_breaking)

    def UnLoaded(self) -> None:
        if self._handler is None:
            return
        bridge = self._get_lessons_bridge()
        bridge.RemoveOnBreakingTimeHandler(self._handler)
        self._handler = None
